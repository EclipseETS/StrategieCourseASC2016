function puissancePV = solarArrayModel(latitude, longitude, altitude, pente, heure, densite_de_puissance_incidente)
...
puissancePV = SurfaceTotalePV * polyval(PV_efficiency_model, El) * densite_de_puissance_incidente;
