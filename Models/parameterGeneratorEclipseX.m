...
% load('../Data/TrackPMGInner10m.mat')
% load('../Data/MotorsportParkHasting.mat')
load('../Data/ASC2018_Stage1speed.mat')
% load('../Data/ASC2018_Stage2speed.mat')
% load('../Data/ASC2018_Stage3speed.mat')
% load('../Data/ASC2018_Stage4speed.mat')
% load('../Data/ASC2018_Stage5speed.mat')
...
Eclipse.masse_totale = 275;     % kg % ECLIPSE X : 195 kg sans pilote, pilote avec ballastes : 275 kg
Eclipse.aire_frontale = .9;   % m^2
Eclipse.coef_trainee = 0.11; % Calculer le 10 juin 2018 chez PMG
