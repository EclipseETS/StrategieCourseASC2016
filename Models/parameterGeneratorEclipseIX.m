...
strategy.SoC_ini = 0.48;         % State of Charge actuel(%)
strategy.SoC_min = 0.45;         % Final State of Charge (%)

%% Reglements de la ASC 2016 rev. B
reglement.impound_out = 7/24; % Batterie disponible a partir de 7h00
reglement.impound_in = 20/24; % Batterie non-disponible a partir de 20h00
reglement.fsgp_fin_recharge_matin = 9/24; % Fin de la recharge du matin a 8h45
reglement.heure_depart = 9/24; % HEURE ACTUELLE/PREVUE - Depart a 9h00     (10h la premiere journee de la FSGP) (Actuellement a 13h15)
reglement.heure_arret = 18/24; % Arret a 18h00      (17h les deux dernieres journees de la FSGP)
...
etat_course.heure_depart = datenum([2017,06,17,reglement.heure_depart*24,0,0]); % Format de l'heure : [yyyy, mm, jj, hh, mm, ss]

%% Trouver la vitesse  ******************TEST******************
