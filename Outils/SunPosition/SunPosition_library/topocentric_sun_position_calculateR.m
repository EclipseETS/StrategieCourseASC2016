function topocentric_sun_position = topocentric_sun_position_calculateR(earth_heliocentric_position, loc_llh, observer_local_hour, sun_rigth_ascension, sun_geocentric_declination)
